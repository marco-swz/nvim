return {
	...
	config = function()
		...
		vim.keymap.set("n", "<space>i", function() harpoon:list():select(2) end)
		vim.keymap.set("n", "<space>o", function() harpoon:list():select(3) end)
		vim.keymap.set("n", "<space>p", function() harpoon:list():select(4) end)
